...
// class MyHomesController extends GetxController {
...
//           ? null
//           : lastDocument =
//               await DB.firestore(Categories.maisons).doc(temp.last.id).get();
...
//           realState: realState, collection: Categories.maisons);
//       realStates.update((val) {
