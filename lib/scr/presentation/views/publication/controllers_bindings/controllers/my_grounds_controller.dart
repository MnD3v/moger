...
// class MyRechercheController extends GetxController {
...
//           ? null
//           : lastDocument =
//               await DB.firestore(Categories.terrains).doc(temp.last.id).get();
...
//         realState: realState, collection: Categories.terrains);
//     realStates.update((val) {
