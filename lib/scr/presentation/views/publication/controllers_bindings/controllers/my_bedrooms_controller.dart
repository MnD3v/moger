...
// class MyBedroomsController extends GetxController {
...
//           ? null
//           : lastDocument =
//               await DB.firestore(Categories.chambres).doc(temp.last.id).get();
...
//         realState: realState, collection: Categories.chambres);
//     realStates.update((val) {
